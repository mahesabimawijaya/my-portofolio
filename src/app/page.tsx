...
export default function Home() {
  return (
    <main className="bg-black w-full h-auto px-10 md:px-[100px] lg:px-[200px] py-[130px] flex justify-center">
      <div className="flex flex-col w-full max-w-[990px] h-auto space-y-14">
        <header id="header" className="flex flex-col items-center space-y-10 md:space-y-0 md:items-start md:flex-row opacity-0 animate-slide-in">
          <div id="pics" className="relative w-[200px] h-[200px] xl:w-[300px] xl:h-[300px]">
        ...
        <div id="body" className="border border-white text-white w-full h-auto rounded-md px-[40px] py-[30px] opacity-0 animate-slide-in">
