    ...
    <main className="bg-black w-full h-auto xl:px-[200px] py-[130px] flex justify-center">
      <div className="flex flex-col w-full max-w-[910px] h-auto space-y-16 items-center lg:items-start">
        ...
        <div id="projects-container" className="flex flex-col w-full space-y-20 px-10">
          <div id="palugada-store" className="flex flex-col bg-white h-auto rounded-md">
            ...
            <div id="project-desc" className="flex flex-col py-6 px-8">
              <div className="flex flex-col h-[50px] space-y-3 mb-5 md:mb-0 md:space-y-0 md:flex-row items-center justify-between">
                <Reveal>
          ...
          <div id="unify" className="flex flex-col bg-white h-auto rounded-md ">
            <div className="relative w-full h-[160px] md:h-[320px] lg:h-[390px] border-b opacity-0 animate-slide-in">
          ...
          <div id="asaba" className="flex flex-col bg-white h-auto rounded-md ">
            <div className="relative w-full h-[160px] md:h-[320px] lg:h-[390px] border-b opacity-0 animate-slide-in">
